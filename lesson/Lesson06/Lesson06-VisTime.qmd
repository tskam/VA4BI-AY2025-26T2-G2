...
::: {style="font-size: 0.6em"}
Source: [Unemployment Horizon Chart](https://www.tableau.com/solutions/gallery/unemployment-horizon-chart).
:::
...
[Slopegraphs for comparing gradients: Slopegraph theory and practice](https://www.edwardtufte.com/notebook/slopegraphs-for-comparing-gradients-slopegraph-theory-and-practice/)

[Horizon Chart](https://en.wikipedia.org/wiki/Horizon_chart)
